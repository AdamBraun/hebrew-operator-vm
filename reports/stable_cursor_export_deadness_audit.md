...
- consumed later: `1` (`0.111`)
- accompanied later: `6` (`0.667`)
...
- ref: `Genesis/31/38` word `1`
  ...
  | --- | --- | --- | --- | --- | --- |
  | `ז:1:1` | `ז` | `port_export` | `accompanied_later` | accompanied by `ה` @ 2 | `true` |
...
- ref: `Exodus/12/2` word `2`
  ...
  | `ז:1:1` | `ז` | `port_export` | `accompanied_later` | accompanied by `ה` @ 3 | `true` |
