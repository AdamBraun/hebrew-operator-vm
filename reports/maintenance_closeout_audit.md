...
| D-004 | Remove `@ts-nocheck` from torah-corpus runtime modules after type hardening                 | `src/reference/scripts/torahCorpus/runtime*.ts`                                                                                          | Owner D           | 2026-05-22 | add strict type tests + incremental lint gates                                                                                                                                  |
