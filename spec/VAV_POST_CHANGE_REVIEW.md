...
| ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `נ / ן / ז` family alignment                                       | These letters were often explained relative to `ו`, so an older connective reading of `ו` can silently distort the family story.    | The forward shape stays aligned: `ו = cont`; `נ = cont + carry`; `ן = cont + supp` with focus advanced; `ז = cont + carry + supp` with focus staying at the source and the resolved export/locked-port structure preserved. |
