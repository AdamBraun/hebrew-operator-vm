...
function printUsage(): void {
  console.log("Usage:");
  console.log('  node dist/src/reference/index.js run "<hebrew>" [--json]');
  console.log('  node dist/src/reference/index.js trace "<hebrew>"');
  console.log('  node dist/src/reference/index.js --trace "<hebrew>"');
  console.log('  node dist/src/reference/index.js "<hebrew>"');
}
