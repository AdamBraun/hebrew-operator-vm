...
export const peOp = makeNoopLetter("פ");
export const tsadiOp = makeNoopLetter("צ");
export const qofOp = makeNoopLetter("ק");
export const reshOp = makeNoopLetter("ר");
export const shinOp = makeNoopLetter("ש");
export const tavOp = makeNoopLetter("ת");
